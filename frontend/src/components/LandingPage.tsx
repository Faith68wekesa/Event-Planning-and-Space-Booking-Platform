...
export const LandingPage: React.FC<LandingPageProps> = ({ onSelectCustomer, onSelectVendor, onSelectVenueOwner }) => {
  return (
    <div style={{
      minHeight: '100vh',
      display: 'flex',
      ...
      <div style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            >
              <div style={{ background: '#10b981', padding: '16px', borderRadius: '50%', color: '#fff' }}>
                <MapPin size={32} />
              </div>
              <div>
                <h3 style={{ color: '#fff', fontSize: '1.3rem', fontWeight: 700, margin: '0 0 8px 0' }}>I'm a Venue Owner</h3>
                <p style={{ color: '#cbd5e1', fontSize: '0.95rem', margin: 0, lineHeight: 1.4 }}>
                  I own a venue and want to list and manage bookings.
                </p>
              </div>
              <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'center', gap: '8px', color: '#ffb800', fontWeight: 600, fontSize: '0.9rem' }}>
                Login / Register <ArrowRight size={16} />
