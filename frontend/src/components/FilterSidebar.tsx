    ...
    <div className="glass-card" style={{ padding: '20px', height: 'fit-content' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', borderBottom: '1px solid rgba(255, 255, 255, 0.1)', paddingBottom: '12px' }}>
        <h3 style={{ fontSize: '1.05rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '8px' }}>
          <SlidersHorizontal size={18} color="#818cf8" /> Filter Results
        </h3>
      ...
      <div style={{ display: 'grid', gap: '16px' }}>
        <div style={{
          ...
          <label htmlFor="verifiedOnly" style={{ fontSize: '0.85rem', fontWeight: 700, color: '#34d399', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.82rem', fontWeight: 600, marginBottom: '6px' }}>
            <span style={{ color: 'var(--text-muted)' }}>Max Budget Rate</span>
            <span style={{ color: '#34d399' }}>KES {filters.max_price.toLocaleString()}</span>
          </div>
          <input
            type="range"
            min={10000}
